...
if(!($stmt = $mysqli->prepare("INSERT INTO zoneEmployee(employeeId, zoneId) VALUES (?,?)"))){
...
//Else the data is okay, so execute the query
	...
	if(!($stmt->bind_param("ii",$_POST['EmployeeId'],$_POST['ZoneId']))){
	...
	//If successful, display how many employees were added.
		...
		echo "Added " . $stmt->affected_rows . " row(s) to zoneEmployee.";
	}
}
?>

		<p>Return to the <a href="zoneEmployee.php">Zone-Employee</a> page</p>
	</body>
</html>